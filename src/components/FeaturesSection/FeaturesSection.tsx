        ...
        <div className={styles.container}>
            ...
            <div className={styles.featuresBlock}>
                ...
                <div className={styles.featuresBlock__feature}>
                    <img src={onlineBankingLogo} alt="featureImage" />
                ...
                <div className={styles.featuresBlock__feature}>
                    <img src={budgetingLogo} alt="featureImage" />
                ...
                <div className={styles.featuresBlock__feature}>
                    <img src={onboardingLogo} alt="featureImage" />
                ...
                <div className={styles.featuresBlock__feature}>
                    <img src={apiLogo} alt="featureImage" />
